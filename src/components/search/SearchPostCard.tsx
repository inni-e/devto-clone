...
const SearchPostCard = (props: Post) => {
  ...
  return (
    <div className="rounded-none sm:rounded-md bg-white overflow-x-hidden flex flex-col border border-gray-200">
      <div className="w-full px-6 pt-6 pb-4 flex justify-start items-center gap-2">
      ...
      <Link href={"/post/" + id}>
        <div className="px-6 sm:pl-16 mb-2 font-bold text-xl sm:text-2xl hover:text-purple-900 text-pretty whitespace-pre">
          {name}
        </div>
      </Link>
